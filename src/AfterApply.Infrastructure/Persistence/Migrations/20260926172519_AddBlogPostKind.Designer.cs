...
namespace AfterApply.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926172519_AddBlogPostKind")]
    partial class AddBlogPostKind
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AfterApply.Domain.Applications.Application", b =>
                {
                    ...
                    b.Property<string>("CapturedJobDescriptionHtml")
                        .HasColumnType("text");
                    ...
                    b.Property<DateOnly?>("PromisedReplyBy")
                        .HasColumnType("date");

                    b.Property<DateTimeOffset?>("PromisedReplySince")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PromisedReplyStatus")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("RejectionNotice")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("AfterApply.Domain.Blog.BlogComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AfterApply.Domain.Blog.BlogCommentHelpfulVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BlogCommentHelpfulVotes", (string)null);
                });

            modelBuilder.Entity("AfterApply.Domain.Blog.BlogCommentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CommentId", "Status");

                    b.ToTable("BlogCommentReports", (string)null);
                });

            modelBuilder.Entity("AfterApply.Domain.Blog.BlogMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BlogMedia", (string)null);
                });

            modelBuilder.Entity("AfterApply.Domain.Blog.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DraftContentHtml")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DraftCoverAlt")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
                    ...
                    b.Property<bool>("DraftHideRegisterCta")
                        .HasColumnType("boolean");

                    b.Property<string>("DraftPrimaryKeyword")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");

                    b.PrimitiveCollection<Guid[]>("DraftRelatedPostIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");

                    b.PrimitiveCollection<string[]>("DraftSecondaryKeywords")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<bool>("HideRegisterCta")
                        .HasColumnType("boolean");
                    ...
                    b.PrimitiveCollection<Guid[]>("RelatedPostIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.PrimitiveCollection<string[]>("SecondaryKeywords")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<Guid?>("TranslationOfPostId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TranslationOfPostId");

                    b.HasIndex("Kind", "Language", "Slug")
                        .IsUnique()
                        .HasDatabaseName("IX_BlogPosts_Kind_Language_Slug")
                        .HasFilter("\"Slug\" IS NOT NULL");

                    b.HasIndex("Kind", "Status", "Language", "PublishedAt");

                    b.ToTable("BlogPosts", (string)null);
                });

            modelBuilder.Entity("AfterApply.Domain.Blog.BlogPostLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AfterApply.Domain.CandidateExperiences.ExperienceInviteDismissal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ExperienceInviteDismissals", (string)null);
                });
            ...
            modelBuilder.Entity("AfterApply.Domain.Companies.Company", b =>
                {
                    ...
                    b.Property<string>("WebsiteSource")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("AfterApply.Domain.Companies.CompanyProfileSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompanyId", "Platform", "UserId")
                        .IsUnique();

                    b.ToTable("CompanyProfileSubmissions", (string)null);
                });
            ...
            modelBuilder.Entity("AfterApply.Domain.Documents.CvDocumentScan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CvDocumentScans", (string)null);
                });
            ...
            modelBuilder.Entity("AfterApply.Domain.SilenceReports.SilenceReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool?>("PromiseGiven")
                        .HasColumnType("boolean");

                    b.Property<DateOnly>("SilentSinceMonth")
                        .HasColumnType("date");
                    ...
                    b.ToTable("SilenceReports", (string)null);
                });
            ...
            modelBuilder.Entity("AfterApply.Domain.TrackedJobs.TrackedJob", b =>
                {
                    ...
                    b.HasIndex("UserId", "JobUrl");

                    b.ToTable("TrackedJobs", (string)null);
                });

            modelBuilder.Entity("AfterApply.Infrastructure.EmailIntegrations.PendingEmailSignal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PendingEmailSignals", (string)null);
                });
            ...
            modelBuilder.Entity("AfterApply.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RemindersPausedFrom")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("RemindersPausedUntil")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("AfterApply.Domain.Blog.BlogComment", b =>
                {
                    b.HasOne("AfterApply.Domain.Blog.BlogComment", null)
                        .WithMany()
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AfterApply.Domain.Blog.BlogPost", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AfterApply.Domain.Blog.BlogPost", b =>
                {
                    ...
                    b.HasOne("AfterApply.Domain.Blog.BlogMedia", null)
                        .WithMany()
                    ...
                    b.HasOne("AfterApply.Domain.Blog.BlogPost", null)
                        .WithMany()
                        .HasForeignKey("TranslationOfPostId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
