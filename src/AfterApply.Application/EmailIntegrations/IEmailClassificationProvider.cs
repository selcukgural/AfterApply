...
/// (OpenAiEmailClassificationProvider, Infrastructure layer) reuses the same OpenAiOptions as
/// IJobMatchingProvider (no separate API key), exercised manually once a real key is configured.
/// Tried only after RuleBasedEmailClassifier returns "NoMatch" for a given email.</summary>
