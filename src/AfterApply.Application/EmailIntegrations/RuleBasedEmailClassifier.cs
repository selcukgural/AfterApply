...
public static class RuleBasedEmailClassifier
{
    ...
    [
        ...
        new(["unfortunately", "moving forward with other candidates", "will not be moving forward",
                "proceed with other candidates", "regret to inform", "maalesef", "olumsuz", "helaas"],
        ...
        // is the only evidence a "new job" suggestion has to go on. Phrases cover EN/DE/TR/NL since a
        // job board or ATS's confirmation email is rarely in the user's own UI language (NL added
        // 2026-09-02 after real Dutch-employer replies — Lely, Thinkwise, Jim Loggers, Hoppinger —
        // turned up in a mailbox audit, same evidence-driven bar as the other three).
        new(["we have received your application", "thank you for your application",
                ...
                "başvurunuz alındı", "başvurunuzu aldık", "başvurunuz için teşekkür ederiz",
                "başvurunuz tarafımıza ulaştı", "başvurunuz bize ulaştı",
                "we hebben je sollicitatie ontvangen", "hartelijk dank voor je sollicitatie",
                "hartelijk dank voor jouw sollicitatie", "bedankt voor je sollicitatie"],
