/*! iframe-resizer parent-side script as served by PayTR (https://www.paytr.com/js/iframeResizer.min.js,
 *  fetched 2026-09-15; iframe-resizer v3.x by David J. Bradshaw, MIT). Self-hosted so the checkout's
 *  CSP keeps script-src 'self' — the child half runs inside PayTR's own payment page. Do not edit;
 *  re-fetch from PayTR if their page stops resizing. */
