...
export function GoogleSignInButton() {
  ...
  const clientId = config.googleAuth?.enabled ? config.googleAuth.clientId : null;
  if (!clientId) {
    return null;
  }
...
// Google's "G" mark, as specified in their sign-in branding guidelines (four solid colours, no
// gradients). Inline so it needs no image host in the CSP.
function GoogleLogo() {
  return (
