...
export function WeeklyJobsAnnouncement() {
  ...
  // The scores follow the postings page's own colour rule: 80 and above good, 60–79 accent.
  const samples = [
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-2" aria-hidden="true">
        <span className="text-[11px] font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400">{t("sampleLabel")}</span>
        {samples.map((sample) => (
          <div
            key={sample.title}
