      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 sm:flex-row sm:justify-between">
        ...
        <div className="flex gap-12">
          ...
          <div className="flex flex-col gap-2 text-sm">
            ...
            <Link href="/cv-tarama" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
              {t("cvScan")}
            </Link>
            <Link href="/benchmark" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
              {t("benchmark")}
            </Link>
            <Link href="/guide" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
              {t("guide")}
            </Link>
            ...
            <Link href="/cookies" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
              {t("cookies")}
            </Link>
          </div>
        </div>
