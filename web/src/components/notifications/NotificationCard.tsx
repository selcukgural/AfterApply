...
interface NotificationCardProps {
  notification: EmailNotificationResponse;
  locale: string;
  reverted: boolean;
  reverting: boolean;
 ...
 */
export function NotificationCard({ notification: n, locale, reverted, reverting, onRevert, onDismiss }: NotificationCardProps) {
    ...
    >
      <div className="mb-2 flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">{new Date(n.createdAt).toLocaleString(locale)}</p>
        </div>
