// Plain <img>, not next/image: real screenshot dimensions aren't known until the
// captures in web/public/help/screenshots are produced, and next/image requires
// fixed width/height (or a sized `fill` container) up front.
