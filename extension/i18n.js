...
const STRINGS = {
  en: {
    ...
    popup: {
      ...
      noJob: "Nothing that looks like a job posting on this page. Open the posting itself — or add it by hand and fill in the two fields yourself.",
      addManually: "Add it by hand",
      permissionKnownSite: "{site} posting detected. Allow this extension to read this page and the fields fill themselves.",
      permissionUnknownSite: "Add {site} so this extension can read job postings there. You can take it back any time under Settings.",
      permissionGrant: "Allow",
      permissionDenied: "No permission given, so nothing was read. You can still add the application by hand.",
      autoDetected: "read from the page",
      guessed: "guessed from the page title — check the fields",
      ...
      laterButton: "Apply later",
      savedForLater: "Saved. When you apply, click \"I Applied\" on this page and it moves to your applications.",
      alreadySaved: "Already saved for later.",
      alreadyApplied: "You have already applied to this one — it is in your applications.",
      movedFromSaved: "Moved from saved postings to your applications.",
      whatsNewTitle: "Updated to {version}",
      whatsNewLink: "What's new",
      close: "Close",
      updateReady: "{version} downloaded",
      updateReadyHint: "It takes effect after a restart.",
    ...
    options: {
      ...
      sitePermissionsLabel: "Sites you allowed",
      sitePermissionsHelp: "Job boards you let this extension read, one at a time, from the popup. It only ever reads the page you have open, and only when you ask it to. Remove one and it stops reading that site.",
      sitePermissionsEmpty: "None yet.",
      sitePermissionRemove: "Remove",
    },
  },
  tr: {
    language: "Dil",
    ...
    popup: {
      pageTitle: "e-kariyerim",
      noJob: "Bu sayfada ilana benzeyen bir şey yok. İlanın kendisini aç — ya da elle ekleyip iki alanı kendin doldur.",
      addManually: "Elle ekle",
      permissionKnownSite: "{site} ilanı algılandı. Bu eklentinin sayfayı okumasına izin verirsen alanlar kendiliğinden dolar.",
      permissionUnknownSite: "{site} sitesini ekle ki eklenti oradaki ilanları okuyabilsin. İstediğin an Ayarlar'dan geri alabilirsin.",
      permissionGrant: "İzin ver",
      permissionDenied: "İzin verilmedi, hiçbir şey okunmadı. Başvuruyu yine de elle ekleyebilirsin.",
      autoDetected: "sayfadan okundu",
      guessed: "sayfa başlığından tahmin edildi — alanları kontrol et",
      ...
      laterButton: "Sonra başvur",
      savedForLater: "Kaydedildi. Başvurduğunuzda bu ilanda \"Başvurdum\"a basın; kayıt başvurularınıza taşınır.",
      alreadySaved: "Bu ilan zaten kayıtlı.",
      alreadyApplied: "Bu ilana zaten başvurmuşsunuz — başvurularınızda duruyor.",
      movedFromSaved: "Kaydettiğiniz ilan başvurularınıza taşındı.",
      whatsNewTitle: "{version} sürümüne güncellendi",
      whatsNewLink: "Yenilikler",
      close: "Kapat",
      updateReady: "{version} indirildi",
      updateReadyHint: "Yeniden başlatınca geçerli olur.",
    ...
    options: {
      ...
      sitePermissionsLabel: "İzin verdiğiniz siteler",
      sitePermissionsHelp: "Popup üzerinden, teker teker, bu eklentinin okumasına izin verdiğiniz iş siteleri. Eklenti yalnızca o an açık olan sayfayı, yalnızca siz istediğinizde okur. Birini kaldırdığınızda o siteyi okumayı bırakır.",
      sitePermissionsEmpty: "Henüz yok.",
      sitePermissionRemove: "Kaldır",
    },
  },
};
